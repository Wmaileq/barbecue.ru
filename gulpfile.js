...
function buildJS() {
  return gulp.src([path.src.js + 'rellax.min.js', path.src.js + 'slick.min.js', path.src.js + 'jquery.scrollbar.min.js', path.src.js + 'nouislider.min.js', path.src.js + 'main.js'])
